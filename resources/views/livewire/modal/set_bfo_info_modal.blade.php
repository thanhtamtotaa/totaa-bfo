    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content py-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <span type="text" class="form-control px-2 h-auto">{{ $ngay_vao_lam }}</span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-footer mx-auto">
                ...
                <button wire:click.prevent="save_bfo_info_role()" totaa-click-block-ui class="btn btn-success" wire:loading.attr="disabled">Xác nhận</button>
            </div>
